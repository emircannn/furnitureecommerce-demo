...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    className={cn("text-xs text-zinc-500 font-medium leading-relaxed", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(buttonVariants({ variant: "destructive" }), "rounded-xl font-bold px-4 py-2 text-sm", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      "rounded-xl font-bold px-4 py-2 text-sm text-secondary border-zinc-200 mt-2 sm:mt-0",
      className
    )}
    {...props}
  />
